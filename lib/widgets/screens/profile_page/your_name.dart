    ...
    return Scaffold(
      ...
      body: SafeArea(child: Padding(
        ...
        child: Form(
          ...
          child: Column(
            children: [
              TextFormFieldWidget(textController: nameController, onPressed: (v){}, label: 'Name', obscureText: false,validator: (value){
                if(value!.isEmpty){
                  nameController.text = user.fullName;
              ...
              Align(
                  ...
                  child: ElevatedButton(onPressed: ()async{
                    ...
                    await userProvider.updateUserData(name: nameController.text);
