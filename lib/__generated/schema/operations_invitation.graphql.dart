...
class Variables$Mutation$DeclineChannelInvitation {
  ...
  factory Variables$Mutation$DeclineChannelInvitation.fromJson(
    ...
    result$data['reasonTextId'] =
        fromJson$Enum$DeclineChannelInvitationReasonTextId(
            (l$reasonTextId as String));
  ...
  Enum$DeclineChannelInvitationReasonTextId get reasonTextId =>
      (_$data['reasonTextId'] as Enum$DeclineChannelInvitationReasonTextId);
  ...
  Map<String, dynamic> toJson() {
    ...
    result$data['reasonTextId'] =
        toJson$Enum$DeclineChannelInvitationReasonTextId(l$reasonTextId);
    return result$data;
  }
...
abstract class CopyWith$Variables$Mutation$DeclineChannelInvitation<TRes> {
  ...
  TRes call({
    ...
    Enum$DeclineChannelInvitationReasonTextId? reasonTextId,
  });
}
    ...
    Object? reasonTextId = _undefined,
      ...
      _then(Variables$Mutation$DeclineChannelInvitation._({
        ...
        if (reasonTextId != _undefined && reasonTextId != null)
          'reasonTextId':
              (reasonTextId as Enum$DeclineChannelInvitationReasonTextId),
      }));
}
  ...
  OperationDefinitionNode(
    ...
    variableDefinitions: [
      ...
      VariableDefinitionNode(
        ...
        type: NamedTypeNode(
          name: NameNode(value: 'DeclineChannelInvitationReasonTextId'),
          isNonNull: true,
        ),
        defaultValue: DefaultValueNode(value: null),
        directives: [],
