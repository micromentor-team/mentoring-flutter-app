...
class Input$FindObjectsOptions {
  factory Input$FindObjectsOptions({
    ...
    bool? showRecordId,
    Enum$IncludeFilterOption? includeDeleted,
  ...
  factory Input$FindObjectsOptions.fromJson(Map<String, dynamic> data) {
    ...
    if (data.containsKey('includeDeleted')) {
      final l$includeDeleted = data['includeDeleted'];
      result$data['includeDeleted'] = l$includeDeleted == null
          ? null
          : fromJson$Enum$IncludeFilterOption((l$includeDeleted as String));
    }
    if (data.containsKey('includeArchived')) {
      final l$includeArchived = data['includeArchived'];
      result$data['includeArchived'] = l$includeArchived == null
          ? null
          : fromJson$Enum$IncludeFilterOption((l$includeArchived as String));
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_$data.containsKey('includeDeleted')) {
      ...
      result$data['includeDeleted'] = l$includeDeleted == null
          ? null
          : toJson$Enum$IncludeFilterOption(l$includeDeleted);
    }
    if (_$data.containsKey('includeArchived')) {
      final l$includeArchived = includeArchived;
      result$data['includeArchived'] = l$includeArchived == null
          ? null
          : toJson$Enum$IncludeFilterOption(l$includeArchived);
    }
    return result$data;
  }
  ...
  TRes call({
    ...
    Object? includeArchived = _undefined,
      ...
      _then(Input$FindObjectsOptions._({
        ...
        if (includeDeleted != _undefined)
          'includeDeleted': (includeDeleted as Enum$IncludeFilterOption?),
...
enum Enum$IncludeFilterOption { include, exclude, only, $unknown }

String toJson$Enum$IncludeFilterOption(Enum$IncludeFilterOption e) {
  switch (e) {
    case Enum$IncludeFilterOption.include:
      return r'include';
    case Enum$IncludeFilterOption.exclude:
      return r'exclude';
    case Enum$IncludeFilterOption.only:
      return r'only';
    case Enum$IncludeFilterOption.$unknown:
      return r'$unknown';
  }
}

Enum$IncludeFilterOption fromJson$Enum$IncludeFilterOption(String value) {
  switch (value) {
    case r'include':
      return Enum$IncludeFilterOption.include;
    case r'exclude':
      return Enum$IncludeFilterOption.exclude;
    case r'only':
